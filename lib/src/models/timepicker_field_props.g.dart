...
TimePickerComponentProperties _$TimePickerComponentPropertiesFromJson(
    ...
    TimePickerComponentProperties(
      ...
      timePickerEntryMode:
          $enumDecodeNullable(_$TimePickerEntryModeEnumMap, json['time_picker_entry_mode']) ??
...
Map<String, dynamic> _$TimePickerComponentPropertiesToJson(
    ...
    <String, dynamic>{
      ...
      'time_picker_entry_mode': _$TimePickerEntryModeEnumMap[instance.timePickerEntryMode]!,
